...
<template>
    <div class="w-full h-full flex flex-col px-12  text-white">
        <div class="h-1/5 grid grid-cols-12 w-full py-8 px-2" style="background: hsla(0,0%,100%,.3);">
            ...
            <div class="flex flex-col col-span-9 justify-center text-2xl">
                <div>
                    课后安排:<span>未签到</span>
                </div>
                <div class="text-1xl">查看情况:---</div>
            </div>
            <div class="col-start-11 col-end-13 grid grid-cols-2">
